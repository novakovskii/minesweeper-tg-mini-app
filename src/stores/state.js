...
export const useStateStore = defineStore('state', {
  state: () => ({
    ...
    icons: {
      ...
      'cross': '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 20.503C14.2543 20.503 16.4164 19.6075 18.0104 18.0134C19.6045 16.4193 20.5 14.2573 20.5 12.003C20.5 9.74866 19.6045 7.58665 18.0104 5.99259C16.4164 4.39854 14.2543 3.503 12 3.503C9.74567 3.503 7.58366 4.39854 5.9896 5.99259C4.39554 7.58665 3.50001 9.74866 3.50001 12.003C3.50001 14.2573 4.39554 16.4193 5.9896 18.0134C7.58366 19.6075 9.74567 20.503 12 20.503ZM2.00001 12.003C1.99842 13.3761 2.28041 14.7348 2.82829 15.9938C3.37618 17.2529 4.17816 18.3853 5.18401 19.32C6.11871 20.3255 7.25095 21.1273 8.50984 21.675C9.76873 22.2227 11.1271 22.5046 12.5 22.503C18.023 22.503 22.365 18.024 22.5 12.503C22.641 6.706 17.797 1.862 12 2.003C6.47901 2.138 2.00001 6.48 2.00001 12.003Z" fill="#2C3034"/> <path d="M15.695 15.719C15.5083 15.9054 15.2552 16.01 14.9914 16.01C14.7276 16.01 14.4746 15.9054 14.2879 15.719L11.9869 13.4181L9.68531 15.7197C9.49604 15.8928 9.24734 15.9861 8.99097 15.9804C8.7346 15.9746 8.49033 15.8702 8.30901 15.6889C8.12769 15.5076 8.02328 15.2633 8.01754 15.0069C8.01179 14.7506 8.10515 14.5019 8.27816 14.3126L10.5791 12.0117L8.27675 9.70933C8.10373 9.52006 8.01038 9.27136 8.01612 9.01499C8.02187 8.75863 8.12627 8.51435 8.30759 8.33303C8.48892 8.15171 8.73319 8.0473 8.98956 8.04156C9.24592 8.03581 9.49463 8.12917 9.68389 8.30219L11.9848 10.6031L14.2857 8.30219C14.4744 8.12515 14.7245 8.02845 14.9831 8.03255C15.2418 8.03665 15.4887 8.14122 15.6716 8.32415C15.8546 8.50707 15.9591 8.75398 15.9632 9.01264C15.9673 9.2713 15.8706 9.52141 15.6936 9.71004L13.3927 12.011L15.6936 14.3119C16.0825 14.7008 16.0825 15.3301 15.6936 15.719L15.695 15.719Z" fill="#2C3034"/> </svg>'
    },
  })
})